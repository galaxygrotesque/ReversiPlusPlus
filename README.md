...
![A banner showcasing Ao3’s navigation bar in ReversiPlusPlus’s colour palette.](img/banner-rpp.png)
...
|                              Ao3                               |                             Reversi                            |                           Reversi++                          |
| :------------------------------------------------------------: | :------------------------------------------------------------: | :----------------------------------------------------------: |
| ![Comparison image: Ao3’s default skin.](img/skin-vanilla.png) | ![Comparison image: Ao3’s Reversi skin.](img/skin-reversi.png) | ![Comparison image: ReversiPlusPlus skin.](img/skin-rpp.png) |
...
|                                  Ao3                                   |                                 Reversi                                |                            Reversi++                            |
| :--------------------------------------------------------------------: | :--------------------------------------------------------------------: | :-------------------------------------------------------------: |
| ![Comparison image: tags in Ao3’s default skin.](img/tags-vanilla.png) | ![Comparison image: tags in Ao3’s Reversi skin.](img/tags-reversi.png) | ![Comparison image: tags in ReversiPlusPlus.](img/tags-rpp.png) |
...
2. While logged in, go to your dashboard.
    ...
    ![The user navigation dropdown menu on Ao3 with “My Dashboard” highlighted.](img/install-01.png)

3. On the dashboard, select `Skins`.

    ![Ao3’s dashboard navigation menu with a light blue arrow pointing to the “Skins” option.](img/install-02.png)

4. The Skins page will have multiple buttons. In the top right-hand corner, select `Create Site Skin`.

    ![The Skins page with a light blue arrow pointing to a button that reads “Create Site Skin”.](img/install-03.png)

    Welcome to the Create New Site Skin page!

    ![An image of the Create New Skin page featuring various options and empty fields to enter text.](img/install-04.png)
...
5. Fill in the following fields:
    ...
    **Don’t submit just yet!**
    ...
    ![A large text box labelled “CSS” with a light blue arrow pointing to a button labelled “Show ↓” underneath it.](img/install-05.png)

    You’ll get a section that looks like this:

    ![The advanced options section with two light blue arrows. The first arrow points to the option “add on to archive skin”. The second arrow points to a checkbox labelled “all”.](img/install-06.png)
...
7. Hit `Submit`!
    ...
    ![An image of a “Submit” button with multiple indicative light blue lines drawn around it.](img/install-07.png)
